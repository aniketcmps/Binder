                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3 text-left">
                                    <a href="org-pages.php?id=<?php echo $jobid?>" class="btn-floating btn-large waves-effect waves-light red no-person-button" data-jobid="<?php echo $id?>" data-email="<?php echo $email?>"><i
                                            class="material-icons">clear</i></a>
                                </div>
                                <div class="col-xs-3 text-right">
                                    <a href="org-pages.php?id=<?php echo $jobid?>" class="btn-floating btn-large waves-effect waves-light green yes-person-button" data-jobid="<?php echo $id?>"><i
