        ...
        <div class="col-md-6">
            <div class="card white darken-1">
                <div class="card-content">
                    <span class="card-title black-text">Register your organization</span>

                    <form class="col-md-12" id="register-form" action="scripts/register-org.php" method="POST">
                        <div class="row">
                            <div class="input-field col-md-12">
                                <input id="first_name" type="text" class="validate text-black" name="name">
