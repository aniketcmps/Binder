            ...
            <div class="card-action">
                <div class="row">
                    ...
                    <div class="col-xs-3 text-left">
                        <a href="pages.php" class="btn-floating btn-large waves-effect waves-light red no-job-button" data-id="<?php $id?>"><i
                                class="material-icons">clear</i></a>
                    </div>
                    <div class="col-xs-3 text-right">
                        <a href="pages.php" class="btn-floating btn-large waves-effect waves-light green yes-job-button" data-id="<?php $id?>"><i
